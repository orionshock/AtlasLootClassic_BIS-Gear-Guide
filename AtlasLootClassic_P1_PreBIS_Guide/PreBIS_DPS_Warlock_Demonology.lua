...
data[ _FilePrefix ] ={
	...
	items = {
		...
		{	--Hands
			...
			[NORMAL_DIFF] = {
				{1,21585, nil, nil, "BiS" },
				{2,31149, nil, nil, "Easy to Obtain" },
		...
		{	--Trinkets
			name = "Trinkets",
			[NORMAL_DIFF] = {
				{1,19337, nil, nil, "Demons and Undead" },
				{2,23207, nil, nil, "BiS" },
				{3,29370, nil, nil, "BiS" },
				{4,27683, nil, nil, "Under Hit Cap" },
				{5,29132, nil, nil, "Under Hit Alternative" },
				{6,19379, nil, nil, "Alternative" },
				{7,23046, nil, nil, "Optional" },
			},
		},
		{	--1-Handed Weapons
		...
		{	--Offhands
			...
			[NORMAL_DIFF] = {
				...
				{2,29272, nil, nil, "Alternative Over Hit Cap" },
