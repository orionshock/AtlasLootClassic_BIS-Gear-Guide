...
data[ _FilePrefix ] ={
	...
	items = {
		...
		{	--Head Slot
			...
			[NORMAL_DIFF] = {
				{1,24266, nil, nil, "BiS" },
				{2,28415, nil, nil, "Optional" },
				{3,28278, nil, nil, "Optional" },
				{4,28193, nil, nil, "Optional" },
				{5,28169, nil, nil, "Optional", [ATLASLOOT_IT_ALLIANCE] = false, [ATLASLOOT_IT_HORDE] = true },
		...
		{	--Hands
			...
			[NORMAL_DIFF] = {
				...
				{3,21585, nil, nil, "Optional" },
				{4,27537, nil, nil, "Optional" },
				{5,29317, nil, nil, "Optional" },
				{6,27465, nil, nil, "Optional" },
				{7,30924, nil, nil, "Easy to Obtain" },
				{8,30930, nil, nil, "Easy to Obtain" },
			},
		},
		{	--Waist
			name = "Waist",
			[NORMAL_DIFF] = {
				...
				{3,29241, nil, nil, "Optional" },
				{4,22730, nil, nil, "Optional" },
				{5,31461, nil, nil, "Optional" },
				{6,27795, nil, nil, "Optional" },
				{7,30923, nil, nil, "Easy to Obtain" },
				{8,29771, nil, nil, "Easy to Obtain" },
			},
		},
		{	--Legs
			name = "Legs",
		...
		{	--Neck
			...
			[NORMAL_DIFF] = {
				...
				{2,27758, nil, nil, "BiS" },
				{3,31338, nil, nil, "BiS" },
				{4,21608, nil, nil, "Optional" },
				{5,29368, nil, nil, "Optional" },
				{6,23057, nil, nil, "Optional" },
				{7,18814, nil, nil, "Optional" },
		...
		{	--Rings
			...
			[NORMAL_DIFF] = {
				...
				{2,31339, nil, nil, "BiS" },
				{3,21709, nil, nil, "BiS" },
				{4,29367, nil, nil, "Optional" },
				{5,29352, nil, nil, "Optional" },
				{6,29172, nil, nil, "Optional" },
				{7,23062, nil, nil, "Optional" },
				{8,29126, nil, nil, "Optional" },
				{9,28555, nil, nil, "Optional" },
				{10,31075, nil, nil, "Easy to Obtain" },
				{11,30366, nil, nil, "Easy to Obtain" },
				{12,32774, nil, nil, "Easy to Obtain" },
			},
		},
		{	--Trinkets
			name = "Trinkets",
			[NORMAL_DIFF] = {
				...
				{6,19339, nil, nil, "Optional" },
				{7,19379, nil, nil, "Optional" },
				{8,23046, nil, nil, "Optional" },
				{9,28418, nil, nil, "Optional" },
				{10,29179, nil, nil, "Optional" },
				{11,28040, nil, nil, "Easy to Obtain" },
				{12,nil, nil, nil, "Easy to Obtain", [ATLASLOOT_IT_HORDE] = 25620, [ATLASLOOT_IT_ALLIANCE] = 25619 },
			},
		},
		{	--1H Wep
		...
		{	--Offhand
			...
			[NORMAL_DIFF] = {
				{1,29271, nil, nil, "BiS" },
				{2,28412, nil, nil, "Optional" },
				{3,28187, nil, nil, "Optional" },
		...
		{	--Wands
			...
			[NORMAL_DIFF] = {
				{1,28386, nil, nil, "BiS" },
				{2,22820, nil, nil, "Optional" },
				{3,25939, nil, nil, "Optional" },
				{4,29350, nil, nil, "Optional" },
