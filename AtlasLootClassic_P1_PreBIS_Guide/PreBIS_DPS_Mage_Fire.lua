...
data[ _FilePrefix ] ={
	...
	items = {
		...
		{	--Shoulders
			...
			[NORMAL_DIFF] = {
				{1,30925, nil, nil, "BiS" },
				{2,27778, nil, nil, "Optional" },
				{3,27796, nil, nil, "Optional" },
				{4,22983, nil, nil, "Optional" },
				{5,27994, nil, nil, "Optional" },
		...
		{	--Legs
			...
			[NORMAL_DIFF] = {
				...
				{6,28212, nil, nil, "Optional" },
				{7,23070, nil, nil, "Optional" },
		...
		{	--Feet
			...
			[NORMAL_DIFF] = {
				...
				{4,22500, nil, nil, "Optional" },
				{5,29242, nil, nil, "Optional" },
				{6,30519, nil, nil, "Easy to Obtain" },
				{7,30398, nil, nil, "Easy to Obtain" },				
			},
		},
		{	--Neck
			name = "Neck",
		...
		{	--Rings
			...
			[NORMAL_DIFF] = {
				...
				{10,23237, nil, nil, "Optional" },
				{11,29352, nil, nil, "Optional" },
				{12,31075, nil, nil, "Easy to Obtain" },
				{13,30366, nil, nil, "Easy to Obtain" },
				{14,32774, nil, nil, "Easy to Obtain" },
			},
		},
		{	--Trinkets
			name = "Trinkets",
