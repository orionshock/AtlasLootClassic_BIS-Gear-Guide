...
data[ _FilePrefix ] ={
	...
	items = {
		...
		{	--Legs
			...
			[NORMAL_DIFF] = {
				{1,24262, nil, nil, "BiS" },
				{2, nil, nil, nil, "Option", [ATLASLOOT_IT_HORDE] = 29141, [ATLASLOOT_IT_ALLIANCE] = 29142 },
				{3,30531, nil, nil, "Optional" },
				{4,29343, nil, nil, "Optional" },
				{5,30532, nil, nil, "Optional" },
				{6,28212, nil, nil, "Optional" },
				{7,27492, nil, nil, "Optional" },
				{8,28185, nil, nil, "Optional" },
			},
		},
		{	--Feet
			name = "Feet",
