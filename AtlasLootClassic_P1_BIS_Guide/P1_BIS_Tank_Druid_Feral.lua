	...
	items = {
		{
			name = "Mitigation BIS",
			[NORMAL_DIFF] = {
				{ 01, 29098 },	{ 16, [ATLASLOOT_IT_HORDE] = 28423, [ATLASLOOT_IT_ALLIANCE] = 28986 },
				{ 02, 28509 },	{ 17, 29099 },
				{ 03, 29100 },	{ 18, 30674 },
				{ 04, 28660 },	{ 19, 29279 },
				{ 05, 29096 },	{ 20, 28792 },
				{ 06, [ATLASLOOT_IT_HORDE] = 28445, [ATLASLOOT_IT_ALLIANCE] = 28978 },	{ 21, 28830 },
				{ 07, 29097 },	{ 22, 23835 },
				{ 09, 28476 },
				{ 11, 23198 },
			}
		},
		{
			...
			[NORMAL_DIFF] = {
				{ 01, 29098 },	{ 16, [ATLASLOOT_IT_HORDE] = 28423, [ATLASLOOT_IT_ALLIANCE] = 28986 },
				{ 02, 28509 },	{ 17, 29099 },
				{ 03, 29100 },	{ 18, [ATLASLOOT_IT_HORDE] = 28422, [ATLASLOOT_IT_ALLIANCE] = 28987 },
				{ 04, 28672 },	{ 19, 29279 },
				{ 05, 29096 },	{ 20, 30834 },
				{ 06, [ATLASLOOT_IT_HORDE] = 28424, [ATLASLOOT_IT_ALLIANCE] = 28988 },	{ 21, 28830 },
				{ 07, 30644 },	{ 22, 29383 },
				{ 09, 28476 },
				{ 11, 23198 },
			}
		...
		{	--Wrist
			name = "Wrist",
			[NORMAL_DIFF] = {
				{1, nil, nil, nil, "Best", [ATLASLOOT_IT_HORDE] = 28445, [ATLASLOOT_IT_ALLIANCE] = 28978 },
				{2, nil, nil, nil, "Best", [ATLASLOOT_IT_HORDE] = 28424, [ATLASLOOT_IT_ALLIANCE] = 28988 },
				{3,29263, nil, nil, "Close Second" },
				{4,30944, nil, nil, "Alternative" },
				{5,28514, nil, nil, "Alternative" },
				{6,29246, nil, nil, "Alternative" },
			},
		...
		{	--Waist
			...
			[NORMAL_DIFF] = {
				...
				{4, nil, nil, nil, "Best Defense swap", [ATLASLOOT_IT_HORDE] = 28423, [ATLASLOOT_IT_ALLIANCE] = 28986 },
				{5,29247, nil, nil, "Alternative" },
				{6,nil, nil, nil, "Alternative", [ATLASLOOT_IT_HORDE] = 28443, [ATLASLOOT_IT_ALLIANCE] = 28976 },
			},
		},
		{	--Legs
			name = "Legs",
		...
		{	--Feet
			...
			[NORMAL_DIFF] = {
				...
				{3, nil, nil, nil, "Best Defense swap", [ATLASLOOT_IT_HORDE] = 28422, [ATLASLOOT_IT_ALLIANCE] = 28987 },
				{4,29265, nil, nil, "Alternative" },
				{5,25691, nil, nil, "Recommended Pre-raid Mitigation" },
				{6,28339, nil, nil, "Recommended Pre-raid Threat" },
			},
		},
		{	--Neck
			name = "Neck",
