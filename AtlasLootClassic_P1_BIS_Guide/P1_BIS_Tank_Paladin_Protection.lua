	...
	items = {
		...
		},
		{
			...
			[NORMAL_DIFF] = {
				...
				{ 09, 25788, nil, nil, "Option", [ATLASLOOT_IT_ALLIANCE] = true, [ATLASLOOT_IT_HORDE] = false },
		...
		},
		{
			...
			[NORMAL_DIFF] = {
				...
				{ 12, nil, nil, nil, "Option", [ATLASLOOT_IT_HORDE] = 25809, [ATLASLOOT_IT_ALLIANCE] = 25803 },
		...
		},
		{
			...
			[NORMAL_DIFF] = {
				...
				{ 02, 28793, nil, nil, "Best - Threat" },	
				{ 03, 28407, nil, nil, "Best - Defensive" },
				{ 04, 28675, nil, nil, "Viable - Defensive" },
				{ 05, 28792, nil, nil, "Viable - Defensive" },
				{ 06, 31319, nil, nil, "Viable - Defensive" },
				{ 07, 27822, nil, nil, "Viable - Defensive" },
				{ 08, 28211, nil, nil, "Viable - Defensive" },
				{ 09, 29384, nil, nil, "Viable - Defensive" },
				{ 10, 31078, nil, nil, "Viable - Defensive" },
				{ 11, 27436, nil, nil, "Viable - Defensive" },
				{ 12, 24088, nil, nil, "Viable - Defensive" },
				{ 13, 31924, nil, nil, "Viable - Defensive" },
				{ 14, 29323, nil, nil, "Viable - Defensive" },
				{ 15, 28265, nil, nil, "Viable - Defensive" },
			},
		},
		{
			name = "Trinkets",
		...
		},
		{
			...
			[NORMAL_DIFF] = {
				...
				{ 05, nil, nil, nil, "Viable", [ATLASLOOT_IT_HORDE] = 29155, [ATLASLOOT_IT_ALLIANCE] = 29153 },
				{ 06, nil, nil, nil, "Viable - SoB", [ATLASLOOT_IT_HORDE] = 29165, [ATLASLOOT_IT_ALLIANCE] = 29156 },
