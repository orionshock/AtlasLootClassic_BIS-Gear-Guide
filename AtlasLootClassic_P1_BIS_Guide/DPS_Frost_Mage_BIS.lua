	...
	items = {
		...
		{	--Hands
			...
			[NORMAL_DIFF] = {
				...
				{4,28780, nil, nil, "Optional" },
				{5,27465, nil, nil, "Optional" },
				{6,27493, nil, nil, "Optional" },
				{7,21585, nil, nil, "Optional" },
				{8,30924, nil, nil, "Easy to Obtain" },
				{9,30930, nil, nil, "Easy to Obtain" },
			},
		},
		{	--Waist
			name = "Waist",
			[NORMAL_DIFF] = {
				{1,24256, nil, nil, "BiS" },
				{2,30673, nil, nil, "Optional" },
				{3,28799, nil, nil, "Optional" },
				{4,29241, nil, nil, "Optional" },
				{5,22730, nil, nil, "Optional" },
				{6,28654, nil, nil, "Optional" },
				{7,31461, nil, nil, "Optional" },
				{8,30923, nil, nil, "Easy to Obtain" },
				{9,29771, nil, nil, "Easy to Obtain" },
			},
		},
		{	--Legs
			name = "Legs",
		...
		{	--Feet
			...
			[NORMAL_DIFF] = {
				{1,21870, nil, nil, "BiS" },
				{2,28585, nil, nil, "Optional" },
				{3,28517, nil, nil, "Optional" },
				{4,28406, nil, nil, "Optional" },
				{5,27821, nil, nil, "Optional" },
				{6,28179, nil, nil, "Optional" },
				{7,29242, nil, nil, "Optional" },
				{8,30519, nil, nil, "Easy to Obtain" },
				{9,30398, nil, nil, "Easy to Obtain" },
			},
		},
		{	--Neck
			name = "Neck",
		...
		{	--Rings
			...
			[NORMAL_DIFF] = {
				...
				{13,29352, nil, nil, "Optional" },
				{14,31075, nil, nil, "Easy to Obtain" },
				{15,30366, nil, nil, "Easy to Obtain" },
				{16,32774, nil, nil, "Easy to Obtain" },
			},
		},
		{	--Trinkets
			name = "Trinkets",
