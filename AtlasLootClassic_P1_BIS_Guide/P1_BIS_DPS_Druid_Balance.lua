	...
	items = {
		...
		{	--Head Slot
			...
			[NORMAL_DIFF] = {
				...
				{7,28169, nil, nil, "Option", [ATLASLOOT_IT_ALLIANCE] = false, [ATLASLOOT_IT_HORDE] = true },
		...
		{	--Legs
			...
			[NORMAL_DIFF] = {
				...
				{4, nil, nil, nil, "Option", [ATLASLOOT_IT_HORDE] = 29141, [ATLASLOOT_IT_ALLIANCE] = 29142 },
				{5,30531, nil, nil, "Option" },
				{6,29343, nil, nil, "Option" },
				{7,30532, nil, nil, "Option" },
				{8,28212, nil, nil, "Option" },
				{09,27492, nil, nil, "Option" },
				{10,28185, nil, nil, "Option" },
			},
		},
		{	--Feet
			name = "Feet",
		...
		{	--1H Wep
			...
			[NORMAL_DIFF] = {
				{1,28770, nil, nil, "BiS" },
				{2,30723, nil, nil, "BiS" },
				{3,30832, nil, nil, "Option" },
				{4,28297, nil, nil, "PvP" },
				{5,32450, nil, nil, "PvP" },
				{6,23554, nil, nil, "Option" },
				{7,27543, nil, nil, "Option" },
				{8,23458, nil, nil, "PvP" },
				{9,27937, nil, nil, "Option" },
				{10,27741, nil, nil, "Option" },
				{11,27868, nil, nil, "Option" },
			},
		},
		{	--2H Wep
